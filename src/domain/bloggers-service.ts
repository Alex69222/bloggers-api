...
export class BloggersService{
    ...
    async getBloggerPosts(pageNumber: number, pageSize: number, id: string, userId: string | undefined):Promise<PaginationType<Omit<PostType, '_id'>>> {
        const { bloggerPostsCount, bloggerPosts }= await this.bloggersRepository.getBloggerPosts(pageNumber, pageSize, id, userId)
